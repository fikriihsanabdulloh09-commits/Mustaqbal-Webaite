...
export default function KurikulumPage() {
    ...
    async function fetchDocuments() {
        ...
        try {
            ...
            toast.error('Gagal memuat dokumen kurikulum');
        } finally {
            setLoading(false);
        }
    }
    ...
    async function handleSubmit() {
        try {
            ...
            if (editingItem) {
                ...
                if (error) throw error;
                toast.success('Dokumen kurikulum berhasil diupdate');
            } else {
                const { error } = await supabase
                    .from('documents')
                    .insert([{ ...formData, category: 'kurikulum' }]);

                if (error) throw error;
                toast.success('Dokumen kurikulum berhasil ditambahkan');
            }
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-3xl font-bold tracking-tight">Dokumen Kurikulum</h2>
                    <p className="text-gray-500 mt-1">Kelola dokumen kurikulum untuk diunduh pengunjung</p>
                </div>
                <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                    ...
                    <DialogContent>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                {editingItem ? 'Perbarui informasi dokumen' : 'Tambahkan dokumen kurikulum baru'}
                            </DialogDescription>
                        </DialogHeader>
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <Input
                                    ...
                                    placeholder="kurikulum-2024.pdf"
                                />
                            </div>
                            <div>
                                ...
                                <Input
                                    ...
                                    placeholder="https://example.com/kurikulum-2024.pdf"
                                />
                            </div>
                            <div>
                ...
                <CardContent>
                    {documents.length === 0 ? (
                        <div className="text-center py-12 text-gray-500">
                            ...
                            <p>Belum ada dokumen. Klik tombol "Tambah Dokumen" untuk menambahkan.</p>
                        </div>
                    ) : (
                        <Table>
                            <TableHeader>
